...
|---------|------------|------|
| [**AI Assistant using MCP**](https://github.com/Aniketsingh12/Ai_assistance_using_MCP) | Multi-source intelligence platform with real-time data retrieval | Python, MCP, LangChain |
| [**Multi-LLM Chatbot**](https://github.com/Aniketsingh12/My_chatbot) | Chatbot that orchestrates multiple LLMs with human-in-the-loop | Python, LLMs, Jupyter |
| [**Text-to-SQL**](https://github.com/Aniketsingh12/text-to-sql) | Natural language to SQL query converter | Python, NLP, SQL |
| [**SQL AI Agent**](https://github.com/Aniketsingh12/SQL_chatbot) | AI-powered SQL chatbot for database queries | Python, LangChain, SQL |
| [**Deep Image Classifier**](https://github.com/Aniketsingh12/-Deep-Image-Classifier) | Image classification using deep learning | Python, PyTorch |
| [**AI Engineer Portfolio**](https://github.com/Aniketsingh12/AI-enginer-protfolio) | Personal portfolio website | HTML, CSS, JavaScript |
...
- ✅ **200+ problems** solved on [LeetCode](https://leetcode.com/)
...
I'm open to freelance projects and collaborations in AI/ML. If you're building something that needs intelligent agents, RAG systems, or AI-powered automation — let's talk.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/aniket-singh-954b721a3/)
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=github&logoColor=white)](https://aniketsingh12.github.io/AI-Engineer-Portfolio/)
[![Twitter](https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://twitter.com/Stickysuraj)
